...
secret='CLIENT_SECRET you started the client docker with'
ClientInterfaceInstance = ClientInterface(server_address=server_address, server_port=server_port,secret=secret)
